...
```
Actually we can see no big change, most changes are near 0. So, I decide to keep these outliers. 
```{r}
...
```
Since the frequency is obviously not independent to each other I decide not to use Bonferroni correction. 
